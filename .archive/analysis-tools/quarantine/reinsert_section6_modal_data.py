#!/usr/bin/env python3
"""
CCNA Section 6 Modal Data Reinsertion Tool
Restores extracted topicDetails data back to section6.html
"""
...
def reinsert_section6_modal_data():
    """Restore extracted modal data back to section6.html"""
    
    # File paths
    html_file = '/var/www/jgibson.site/public_html/section6.html'
    data_file = '/var/www/jgibson.site/public_html/quarantine/section6_extracted_modal_data.json'
    backup_dir = '/var/www/jgibson.site/public_html/quarantine'
    
    print("=== CCNA Section 6 Modal Data Reinsertion ===")
    ...
    backup_file = f'{backup_dir}/section6_pre_reinsertion_{timestamp}.html'
    ...
    js_object = generate_section6_topicdetails_js(topics)
    ...
    if 'EXTRACTED: Modal data moved to quarantine folder' in content:
        ...
        print(f"🎯 Modal content fully restored to section6.html")
...
def generate_section6_topicdetails_js(topics):
...
if __name__ == "__main__":
    success = reinsert_section6_modal_data()
    if success:
        print("\n🚀 Section 6 modal data successfully restored!")
