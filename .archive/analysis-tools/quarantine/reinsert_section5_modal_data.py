#!/usr/bin/env python3
"""
CCNA Section 5 Modal Data Reinsertion Tool
Restores extracted topicDetails data back to section5.html
"""
...
def reinsert_section5_modal_data():
    """Restore extracted modal data back to section5.html"""
    
    # File paths
    html_file = '/var/www/jgibson.site/public_html/section5.html'
    data_file = '/var/www/jgibson.site/public_html/quarantine/section5_extracted_modal_data.json'
    backup_dir = '/var/www/jgibson.site/public_html/quarantine'
    
    print("=== CCNA Section 5 Modal Data Reinsertion ===")
    ...
    backup_file = f'{backup_dir}/section5_pre_reinsertion_{timestamp}.html'
    ...
    js_object = generate_section5_topicdetails_js(topics)
    ...
    if 'EXTRACTED: Modal data moved to quarantine folder' in content:
        ...
        print(f"🎯 Modal content fully restored to section5.html")
...
def generate_section5_topicdetails_js(topics):
...
if __name__ == "__main__":
    success = reinsert_section5_modal_data()
    if success:
        print("\n🚀 Section 5 modal data successfully restored!")
