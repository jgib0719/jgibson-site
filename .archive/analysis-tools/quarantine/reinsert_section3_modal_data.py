#!/usr/bin/env python3
"""
CCNA Section 3 Modal Data Reinsertion Tool
Restores extracted topicDetails data back to section3.html
"""
...
def reinsert_section3_modal_data():
    """Restore extracted modal data back to section3.html"""
    
    # File paths
    html_file = '/var/www/jgibson.site/public_html/section3.html'
    data_file = '/var/www/jgibson.site/public_html/quarantine/section3_extracted_modal_data.json'
    backup_dir = '/var/www/jgibson.site/public_html/quarantine'
    
    print("=== CCNA Section 3 Modal Data Reinsertion ===")
    ...
    backup_file = f'{backup_dir}/section3_pre_reinsertion_{timestamp}.html'
    ...
    js_object = generate_section3_topicdetails_js(topics)
    ...
    if 'EXTRACTED: Modal data moved to quarantine folder' in content:
        ...
        print(f"🎯 Modal content fully restored to section3.html")
...
def generate_section3_topicdetails_js(topics):
...
if __name__ == "__main__":
    success = reinsert_section3_modal_data()
    if success:
        print("\n🚀 Section 3 modal data successfully restored!")
