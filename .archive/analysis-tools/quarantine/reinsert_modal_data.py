...
def reinsert_modal_data():
    ...
    original_topics = """
            // Comprehensive CCNA 200-301 topic information
            const topicDetails = {
                'Route Source': {
                    title: 'Route Source - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'Destination Network': {
                    title: 'Destination Network - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'Administrative Distance': {
                    title: 'Administrative Distance - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'Next Hop Address': {
                    title: 'Next Hop Address - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'Longest Prefix Match': {
                    title: 'Longest Prefix Match - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'IPv4 Static Routes': {
                    title: 'IPv4 Static Routes - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'IPv6 Static Routes': {
                    title: 'IPv6 Static Routes - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'RIP Fundamentals': {
                    title: 'RIP (Routing Information Protocol) Fundamentals',
                    content: `
...
passive-interface FastEthernet0/1</pre>
                ...
                'RIP Timers': {
                    title: 'RIP Timers and Convergence',
                    content: `
...
R 192.168.1.0/24 [120/1] via 10.1.1.2, 00:00:15, Serial0/0/0
                ...
                'Split Horizon': {
                    title: 'Split Horizon Loop Prevention',
                    content: `
...
show ip protocols</pre>
                ...
                'OSPF Neighbor Formation': {
                    title: 'OSPF Neighbor Formation - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
                ...
                'LSA Types': {
                    title: 'LSA Types - CCNA 200-301 Guide',
                    content: `
                        <div class="space-y-6">
                            <section>
...
RIP route:        10.1.1.0/24 [120/2] via 192.168.3.1</pre>
                ...
                'Default Routes': {
                    title: 'Default Routes (Gateway of Last Resort)',
                    content: `
...
ping 8.8.8.8 (test default path)</pre>
                ...
                'Floating Static Routes': {
                    title: 'Floating Static Routes (Backup Routes)',
                    content: `
...
show ip eigrp topology 192.168.1.0/24</pre>
                ...
                'OSPF Areas': {
                    title: 'OSPF Areas and Hierarchical Design',
                    content: `
...
ip ospf 1 area 0</pre>
                ...
                'OSPF Network Types': {
                    title: 'OSPF Network Types and DR Election',
                    content: `
...
area 1 nssa no-summary</pre>
                ...
                'Redistribution Basics': {
                    title: 'Route Redistribution Fundamentals',
                    content: `
...
show ip eigrp topology         # EIGRP topology including external</pre>
                ...
                'Redistribution Loops': {
                    title: 'Redistribution Loop Prevention',
                    content: `
