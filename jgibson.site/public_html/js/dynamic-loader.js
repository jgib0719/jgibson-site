...
class CCNADynamicLoader {
    ...
    async initializeSection1() {
        ...
        this.containerMapping = {
            ...
            '1.7': 'ipv6-grid',           // IPv6 Addressing
            '1.8': 'wireless-grid',        // Wireless Principles
            '1.9': 'virtualization-grid', // Virtualization Fundamentals
            '1.10': 'models-grid',         // Network Models
            '1.11': 'ethernet-grid',       // Ethernet Operations
            '1.12': 'routing-grid',        // IP Routing and Default Gateway
